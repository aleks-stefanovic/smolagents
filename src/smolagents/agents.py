...
from .remote_executors import AgentSandboxExecutor, BlaxelExecutor, DockerExecutor, E2BExecutor, ModalExecutor
...
class CodeAgent(MultiStepAgent):
    ...
    Args:
        ...
        executor_type (`Literal["local", "blaxel", "e2b", "modal", "docker", "agent-sandbox"]`, default `"local"`): Type of code executor.
    ...
    def __init__(
        ...
        executor_type: Literal["local", "blaxel", "e2b", "modal", "docker", "agent-sandbox"] = "local",
    ...
    def create_python_executor(self) -> PythonExecutor:
        if self.executor_type not in {"local", "blaxel", "e2b", "modal", "docker", "agent-sandbox"}:
        ...
        if self.executor_type == "local":
            ...
            remote_executors = {
                ...
                "modal": ModalExecutor,
                "agent-sandbox": AgentSandboxExecutor,
            }
